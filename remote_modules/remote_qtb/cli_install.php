...
echo PHP_EOL . 
     "********************************************" . PHP_EOL;
echo "* Installation of remote_qtb remote module *" . PHP_EOL;
echo "********************************************" . PHP_EOL;
...
$value = read_line("Path to this remote module on this Mac [default: '$remoteqtb_basedir']: ");
if ($value != "")
    $remoteqtb_basedir = $value;

$value = read_line("Path to the local video repository on this Mac [default: '$remoteqtb_recorddir']: ");
if ($value != "")
    $remoteqtb_recorddir = $value;
...
file_put_contents("$remoteqtb_basedir/config.inc", $config);
