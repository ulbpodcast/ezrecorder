...
#define VISCA_FIRST_TIMEOUT	 	 10 // Timeout in seconds before we stop trying reading for the first time
#define VISCA_TIMEOUT			 2 // Timeout in seconds before we stop trying reading when FIRST_TIMEOUT already happened( this is a patch for unresponsive D70 camera that understand commands but doesn't return anything)
