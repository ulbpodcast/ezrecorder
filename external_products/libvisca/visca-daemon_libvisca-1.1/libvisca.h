...
/* uncomment if you want visca-daemon to check received values according to D30 official limits
 if you use another Camera model, I suggest you leave this commented
*/
/*
#define CHECK_VISCA_VALUES   1
*/
/**********************/
/* Message formatting */
/**********************/
