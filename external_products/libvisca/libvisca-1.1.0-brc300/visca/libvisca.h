...
#define VISCA_FIRST_TIMEOUT	 	 10000 // Timeout in milliseconds before we stop trying reading for the first time
#define VISCA_TIMEOUT		         1000 // Timeout in milliseconds before we stop trying reading
