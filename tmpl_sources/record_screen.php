                ...
                <div id="boutonEnregistrement">
                    ...
                    <div id="id2" <?php if(!$redraw || !$already_recording) echo 'style="display:none"'; ?>>
                        ...
                        <div id='btnStop' class="BtnStop">
                            <a href="index.php?action=view_record_submit" onclick="var res = window.confirm('®Stop_recording®'); if(!res) return false;" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/page2/BStopEnr.png',1)"><img src="images/page2/AStopEnr.png" name="Image3" title="®Stop_recording_hover®" border="0" id="Image3" />®Stop_recording_hover®</a>
                        </div>
