...
if (strtoupper(php_uname('s'))==='LINUX'){
	$perms_file = file_get_contents("$remoteffmpeg_local_basedir/setperms_samplinux.sh");
}else{
...
if(!ssh_ping($remote_recorder_username, $remote_recorder_ip)) {
    echo "\033[31mCannot ssh into remote recorder $remote_recorder_username@$remote_recorder_ip from this recorder. \033[0mCheck if our public key is authorized on it, or correct remote IP in global_config.inc if necessary." . PHP_EOL;
} else {
