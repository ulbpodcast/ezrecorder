...
function capture_remotefmle_init(&$pid, $meta_assoc) {
    ...
    if (capture_remotefmle_status_get() == '') {
        ...
        system("sudo -u $remotefmle_username $remote_script_call $remotefmle_ip $remotefmle_recorder_logs $remotefmle_script_init > /dev/null & echo $! > $tmp_dir/pid");
...
function capture_remotefmle_pause($asset) {
    global $remotefmle_script_action;
    global $remotefmle_ip;
    global $remote_script_call;
    global $remotefmle_recorder_logs;
    global $remotefmle_username;
    ...
    if (capture_remotefmle_status_get() == 'recording') {
        system("sudo -u $remotefmle_username $remote_script_call $remotefmle_ip $remotefmle_recorder_logs $remotefmle_script_action > /dev/null &");
