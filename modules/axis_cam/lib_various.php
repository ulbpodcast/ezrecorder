...
function image_resize($input, $output, $maxwidth, $maxheight) {
    ...
    $img_path = array();
    $img_path['broadcasting'] = dirname(__FILE__) . '/broadcasting.png';
    $img_path['connection'] = dirname(__FILE__) . '/connection.png';
    $img_path['error'] = dirname(__FILE__) . '/error.png';
    $img_path['pending'] = dirname(__FILE__) . '/pending.png';
